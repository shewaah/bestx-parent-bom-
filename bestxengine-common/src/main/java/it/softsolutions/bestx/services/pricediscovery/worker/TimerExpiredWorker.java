 ...
 * 
 **/
public class TimerExpiredWorker implements Runnable {

    private ProposalAggregatorListener proposalAggregatorListener;

    public TimerExpiredWorker(ProposalAggregatorListener proposalAggregatorListener) {
        super();
    ...
    @Override
    public void run() {
        proposalAggregatorListener.onTimerExpired();
    }
}
