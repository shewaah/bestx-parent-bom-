...
public class TimerJobMonitorable implements InterruptableJob {
    private static final Logger LOGGER = LoggerFactory.getLogger(TimerJobMonitorable.class);
    
    private JobKey jobKey; 

    public TimerJobMonitorable() {
    }
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        JobExecutionDispatcher.INSTANCE.notifyJobExecution(jobExecutionContext, null, true);
