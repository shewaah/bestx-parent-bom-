 ...
 * 
 **/
public class OrderRevocatedState extends BaseState implements Cloneable {

    public OrderRevocatedState() {
        super(OperationState.Type.OrderRevocated, null);
    }

    public OrderRevocatedState(String comment) {
        super(OperationState.Type.OrderRevocated, null);
        setComment(comment);
    }
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new OrderRevocatedState(getComment());
    }
