 ...
 * 
 **/
public class OrderNotExecutableState extends BaseState implements Cloneable {
	
    public OrderNotExecutableState() {
        super(OperationState.Type.OrderNotExecutable, null);
    }

    public OrderNotExecutableState(String comment) {
        super(OperationState.Type.OrderNotExecutable, null);
        setComment(comment);
    }
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new OrderNotExecutableState();
    }
