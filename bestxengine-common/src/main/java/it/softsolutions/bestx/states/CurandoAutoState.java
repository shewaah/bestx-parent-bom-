 ...
 * 
 **/
public class CurandoAutoState extends BaseState implements Cloneable {
    
    public CurandoAutoState() {
        super(OperationState.Type.CurandoAuto, null);
    }

	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new CurandoAutoState();
	}
