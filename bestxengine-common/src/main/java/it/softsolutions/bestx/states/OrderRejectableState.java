 ...
 * 
 **/
public class OrderRejectableState extends BaseState implements Cloneable {

    private OrderRejectableState() {
        super(OperationState.Type.OrderRejectable, null);
    }

    public OrderRejectableState(String comment) {
        super(OperationState.Type.OrderRejectable, null);
        setComment(comment);
    }
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new OrderRejectableState(getComment());
    }
