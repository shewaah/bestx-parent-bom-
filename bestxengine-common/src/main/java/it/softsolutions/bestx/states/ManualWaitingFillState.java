 ...
 * 
 **/
public class ManualWaitingFillState extends BaseState implements Cloneable {

    public ManualWaitingFillState() {
        super(OperationState.Type.ManualWaitingFill, null);
        setComment("");
    }

    public ManualWaitingFillState(String comment) {
        super(OperationState.Type.ManualWaitingFill, null);
        setComment(comment);
    }
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new ManualWaitingFillState(getComment());
    }
