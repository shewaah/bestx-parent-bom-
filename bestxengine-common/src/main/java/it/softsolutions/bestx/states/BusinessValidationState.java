 ...
 * 
 **/
public class BusinessValidationState extends BaseState implements Cloneable {

    public BusinessValidationState() {
        super(OperationState.Type.BusinessValidation, null);
    }
    
	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new BusinessValidationState();
	}
