 ...
 * 
 **/
public class CurandoState extends BaseState implements Cloneable {

    public CurandoState() {
        super(OperationState.Type.Curando, null);
    }

    public CurandoState(String comment) {
        super(OperationState.Type.Curando, null);
        setComment(comment);
    }
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new CurandoState(this.getComment());
    }
