 ...
 * 
 **/
public class FormalValidationOKState extends BaseState implements Cloneable {

    public FormalValidationOKState() {
        super(OperationState.Type.FormalValidationOK, null);
    }

	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new FormalValidationOKState();
	}
