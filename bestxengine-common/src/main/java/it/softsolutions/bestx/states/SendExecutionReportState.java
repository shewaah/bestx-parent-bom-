 ...
 * 
 **/
public class SendExecutionReportState extends BaseState implements Cloneable {

    public SendExecutionReportState() {
        super(OperationState.Type.SendExecutionReport, null);
    }

    public SendExecutionReportState(String comment) {
        super(OperationState.Type.SendExecutionReport, null);
        setComment(comment);
    }
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new SendExecutionReportState(getComment());
    }
