 ...
 * 
 **/
public class CurandoRetryState extends BaseState implements Cloneable {
   
    public CurandoRetryState() {
        super(OperationState.Type.CurandoRetry, null);
    }

	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new CurandoRetryState();
	}
