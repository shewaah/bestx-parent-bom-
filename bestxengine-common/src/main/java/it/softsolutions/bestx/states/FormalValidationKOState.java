 ...
 * 
 **/
public class FormalValidationKOState extends BaseState implements Cloneable {

   public FormalValidationKOState() {
       super(OperationState.Type.FormalValidationKO, null);
      
   }
   public FormalValidationKOState(String comment) {
       super(OperationState.Type.FormalValidationKO, null);
      setComment(comment);
   }
	...
	public OperationState clone() throws CloneNotSupportedException {
		return new FormalValidationKOState(getComment());
	}
