 ...
 * 
 **/
public class ValidateByPunctualFilterState extends BaseState implements Cloneable {

    public ValidateByPunctualFilterState() {
        super(OperationState.Type.ValidateByPunctualFilter, null);
    }

    public ValidateByPunctualFilterState(String comment) {
        super(OperationState.Type.ValidateByPunctualFilter, null);
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new ValidateByPunctualFilterState();
    }
