...
public class FixGatewayConnector extends XT2BaseConnector implements FixGatewayConnection, XT2ConnectionListener, XT2NotificationListener, XT2ReplyListener {
   ...
   public void init() throws BestXException {
      ...
      Thread t1 = new Thread(fixOrderQueueMonitor);
      t1.setName("FixGW-OrderQueueMonitor" + "-T" + t1.getId());
      t1.start();
      customerOrdersConsumer = new CustomerOrdersConsumer();
      Thread t2 = new Thread(customerOrdersConsumer,"FixGW-OrdersConsumer");
      t2.setName("FixGW-OrderQueueMonitor" + "-T" + t2.getId());
      t2.start();
      ...
      customerRepliesThread.setName("FixGW-RepliesConsumer" + "-T" + customerRepliesThread.getId());
