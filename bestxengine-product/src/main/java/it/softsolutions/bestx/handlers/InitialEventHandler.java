 ...
 * 
 **/
public class InitialEventHandler extends BaseOperationEventHandler {
    
    private static final long serialVersionUID = -5987404784119699672L;
    
    private static final Logger LOGGER = LoggerFactory.getLogger(InitialEventHandler.class);

    /**
     * @param operation
     */
    public InitialEventHandler(Operation operation) {
        super(operation);
    }
