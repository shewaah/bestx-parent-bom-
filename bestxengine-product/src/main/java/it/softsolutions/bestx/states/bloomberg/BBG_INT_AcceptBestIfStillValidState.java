 ...
 * 
 **/
public class BBG_INT_AcceptBestIfStillValidState extends BaseState implements Cloneable {

    public BBG_INT_AcceptBestIfStillValidState() {
        super(OperationState.Type.InternalAcceptBestIfStillValid, MarketCode.BLOOMBERG);
    }

    public BBG_INT_AcceptBestIfStillValidState(String reason) {
        super(OperationState.Type.InternalAcceptBestIfStillValid, MarketCode.BLOOMBERG);
        setComment(reason);
    }
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new BBG_INT_AcceptBestIfStillValidState();
    }
