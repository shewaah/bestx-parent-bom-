...
/**  
*
* Purpose: RTFI different dates executd state  
*
...
* 
**/
public class RTFI_DifferentDatesExecutedState extends BaseState implements Cloneable {

    public RTFI_DifferentDatesExecutedState() {
       super(OperationState.Type.DifferentDatesExecuted, MarketCode.RTFI);
    }
    
     @Override
     public OperationState clone() throws CloneNotSupportedException {
         return new RTFI_DifferentDatesExecutedState();
     }
