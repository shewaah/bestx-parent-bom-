...
* 
**/
public class RTFI_SendRfqState extends BaseState implements Cloneable {

   public RTFI_SendRfqState() {
      super(OperationState.Type.SendRfq, MarketCode.RTFI);
   }
   
	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new RTFI_SendRfqState();
	}
