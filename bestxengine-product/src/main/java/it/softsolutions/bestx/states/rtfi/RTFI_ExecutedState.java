...
* 
**/
public class RTFI_ExecutedState extends BaseState implements Cloneable {

   public RTFI_ExecutedState() {
      super(OperationState.Type.MarketExecuted, MarketCode.RTFI);
   }
   
	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new RTFI_ExecutedState();
	}
