...
/**  
*
* Purpose: Internal market rejected state  
*
...
* 
**/
public class INT_RejectedState extends BaseState implements Cloneable {
	
   public INT_RejectedState(String comment) {
      super(OperationState.Type.ManageCounter, MarketCode.INTERNALIZZAZIONE);
      setComment(comment);
   }
   
   public INT_RejectedState() {
      super(OperationState.Type.ManageCounter, MarketCode.INTERNALIZZAZIONE);
   }

	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new INT_RejectedState(this.getComment());
	}
