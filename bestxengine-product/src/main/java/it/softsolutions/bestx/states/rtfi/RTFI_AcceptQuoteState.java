 ...
 * 
 **/
public class RTFI_AcceptQuoteState extends BaseState implements Cloneable {

    public RTFI_AcceptQuoteState() {
        super(OperationState.Type.AcceptQuote, MarketCode.RTFI);
    }

    public RTFI_AcceptQuoteState(String reason) {
        super(OperationState.Type.AcceptQuote, MarketCode.RTFI);
        setComment(reason);
    }
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new RTFI_AcceptQuoteState();
    }
