 ...
 * 
 **/
public class HibernateSettlementLimitDao implements SettlementLimitDao {
    ...
    public SettlementLimit getValidFilteredLimit(String currencyCode, String countryCode) {
        ...
        SettlementLimit result = null;
        Session session = null;
        try {
            session = sessionFactory.openSession();
            result = (SettlementLimit) session.createQuery("from SettlementLimit where enabled = :enabled and currencyCode = :currencyCode and countryCode = :countryCode")
