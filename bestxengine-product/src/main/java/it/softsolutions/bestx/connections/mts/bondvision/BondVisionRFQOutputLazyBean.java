...
import it.softsolutions.bestx.markets.mts.bondvision.BondVisionMarket;
...
public class BondVisionRFQOutputLazyBean extends XT2OutputLazyBean {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(BondVisionRFQOutputLazyBean.class);
...
//    SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
     ...
     *            the qty multiplier
     */
    public BondVisionRFQOutputLazyBean(MarketOrder marketOrder, BigDecimal qtyMultiplier) {
