...
public interface TradeStacPreTradeConnection extends Connection {
	...
	/**
	 * Set the blpConnectionListener
	 * 
	 * @param blpConnectionListener the blpConnectionListener
	 */
	void setTradeStacPreTradeConnectionListener(TradeStacPreTradeConnectionListener blpConnectionListener);
     ...
     * @throws BestXException if an error occurred during the request subscription
	 */
	void requestInstrumentPriceSnapshot(Instrument instrument, List<MarketMarketMakerSpec> marketMakerCodes) throws BestXException;
}
