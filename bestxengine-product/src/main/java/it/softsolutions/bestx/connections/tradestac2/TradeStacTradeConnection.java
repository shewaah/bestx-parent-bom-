 ...
 * by the BestX client when dealing with a TradeStacTradeConnection.
 * 
 ...
 * 
 **/
public interface TradeStacTradeConnection extends Connection {

    /**
     * Changes the TradeStacTradeConnectionListener.
     * 
     * @param TradeStacTradeConnectionListener
     *            the new TradeStacTradeConnectionListener
     */
    void setTradeStacTradeConnectionListener(TradeStacTradeConnectionListener tradeStacTradeConnectionListener);
