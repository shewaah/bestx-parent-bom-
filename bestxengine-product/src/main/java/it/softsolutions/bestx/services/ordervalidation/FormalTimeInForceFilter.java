 ...
 * 
 **/
public class FormalTimeInForceFilter implements OrderValidator {
    ...
    public OrderResult validateOrder(Operation unused, Order order) {
        ...
        result.setReason("");		
        result.setValid(order.getTimeInForce()!= null);
        if(!result.isValid()) {
            result.setReason(Messages.getString("FormalTimeInForce.0"));
        }
        return result;
    }
