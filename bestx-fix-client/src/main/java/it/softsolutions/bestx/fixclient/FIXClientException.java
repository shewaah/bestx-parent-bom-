...
public class FIXClientException extends Exception {
    ...
    private static final long serialVersionUID = 8274976397197357267L;

    public FIXClientException(String message) {
        super(message);
    }

    public FIXClientException(Throwable throwable) {
        super(throwable);
    }
    
    public FIXClientException(String message, Throwable throwable) {
