@echo off
rem
rem This script starts the Grdlite Simulator application.
rem
rem artifact ref.: bestx-grdlite-simulator
...
SET CURRENT_DIR=C:/softsolutions/bestx/services/bestx-mq-jmx-client-app
...
set OPT_3=-Dss.app.name=BogusGRDLite -cp %CURRENT_DIR%\config;%CURRENT_DIR%\lib\*;
