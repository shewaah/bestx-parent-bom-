...
* 
**/
public interface UserModelFinder {
   
   UserModel getUserByUserName(String userName) throws BestXException;
   
   //String getGroupForUser(String userName) throws BestXException;
