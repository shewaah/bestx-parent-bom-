...
public class MarketAxessMarket extends MarketCommon implements TradeStacPreTradeConnectionListener, TradeStacTradeConnectionListener, ConnectionListener, MarketBuySideConnection,
      MarketPriceConnection, TimerEventListener, Connection, MarketMXBean {
   ...
   @Override
   public void onExecutionReport(String sessionId, String clOrdId, it.softsolutions.marketlibraries.quickfixjrootobjects.fields.ExecType execType,
         it.softsolutions.marketlibraries.quickfixjrootobjects.fields.OrdStatus ordStatus, BigDecimal accruedInterestAmount, BigDecimal accruedInterestRate, BigDecimal lastPrice, String contractNo,
