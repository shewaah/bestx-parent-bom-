 ...
 * 
 **/
public class MA_RejectedState extends BaseState implements OperationState {

	public MA_RejectedState() {
		super(OperationState.Type.Rejected, MarketCode.MARKETAXESS);
	}

	public MA_RejectedState(String comment) {
		super(OperationState.Type.Rejected, MarketCode.MARKETAXESS);
		setComment(comment);
	}
	...
	public OperationState clone() throws CloneNotSupportedException {
		return new MA_RejectedState(this.getComment());
	}
