...
* 
**/
public class MA_SendOrderState extends BaseState implements OperationState {

	public MA_SendOrderState() {
		super(OperationState.Type.SendOrder, MarketCode.MARKETAXESS);
	}

	public MA_SendOrderState(String comment) {
		super(OperationState.Type.SendOrder, MarketCode.MARKETAXESS);
		setComment(comment);
	}
	...
	public OperationState clone() throws CloneNotSupportedException {
		return new MA_SendOrderState(this.getComment());
	}
