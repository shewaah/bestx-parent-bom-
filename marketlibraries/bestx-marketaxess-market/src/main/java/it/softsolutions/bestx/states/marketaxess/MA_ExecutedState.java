 ...
 * 
 **/
public class MA_ExecutedState extends BaseState implements Cloneable {

	public MA_ExecutedState() {
		super(OperationState.Type.MarketExecuted, MarketCode.MARKETAXESS);
	}

	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new MA_ExecutedState();
	}
