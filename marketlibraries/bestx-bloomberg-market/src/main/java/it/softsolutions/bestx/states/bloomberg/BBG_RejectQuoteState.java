 ...
 * 
 **/
public class BBG_RejectQuoteState extends BaseState implements Cloneable {

    public BBG_RejectQuoteState() {
        super(OperationState.Type.RejectQuote, MarketCode.BLOOMBERG);
    }

    public BBG_RejectQuoteState(String rejectedReason) {
        super(OperationState.Type.RejectQuote, MarketCode.BLOOMBERG);
    ...
    public OperationState clone() throws CloneNotSupportedException {
        return new BBG_RejectQuoteState();
    }
