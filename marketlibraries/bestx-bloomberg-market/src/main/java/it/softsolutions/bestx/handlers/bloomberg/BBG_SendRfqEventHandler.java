 ...
 * 
 **/
public class BBG_SendRfqEventHandler extends BaseOperationEventHandler {
    private static final long serialVersionUID = -3944107875602225118L;
    
    private static final Logger LOGGER = LoggerFactory.getLogger(BBG_SendRfqEventHandler.class);
     ...
     * 
     */
    public BBG_SendRfqEventHandler(Operation operation, MarketBuySideConnection bbgConnection, SerialNumberService serialNumberService, long waitingAnswerDelay, MultipleQuotesHandler multipleQuoteHandler,
