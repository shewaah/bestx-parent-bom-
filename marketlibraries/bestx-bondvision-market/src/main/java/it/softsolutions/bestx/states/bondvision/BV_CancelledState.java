 ...
 * 
 **/
public class BV_CancelledState extends BaseState implements OperationState {

	public BV_CancelledState() {
		super(OperationState.Type.Cancelled, MarketCode.BV);
	}

	public BV_CancelledState(String comment) {
		super(OperationState.Type.Cancelled, MarketCode.BV);
		setComment(comment);
	}
	...
	public OperationState clone() throws CloneNotSupportedException {
		return new BV_CancelledState(this.getComment());
	}
}
