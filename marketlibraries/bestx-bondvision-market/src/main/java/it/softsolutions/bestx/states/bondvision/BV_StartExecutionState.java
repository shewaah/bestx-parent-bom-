...
* 
**/
public class BV_StartExecutionState extends BaseState implements OperationState {

	public BV_StartExecutionState() {
		super(OperationState.Type.StartExecution, MarketCode.BV);
	}

	public BV_StartExecutionState(String comment) {
		super(OperationState.Type.StartExecution, MarketCode.BV);
		setComment(comment);
	}
	...
	public OperationState clone() throws CloneNotSupportedException {
		return new BV_StartExecutionState(this.getComment());
	}
