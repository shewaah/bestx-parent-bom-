...
* 
**/
public class BV_SendOrderState extends BaseState implements OperationState {

	public BV_SendOrderState() {
		super(OperationState.Type.SendOrder, MarketCode.BV);
	}

	public BV_SendOrderState(String comment) {
		super(OperationState.Type.SendOrder, MarketCode.BV);
		setComment(comment);
	}
	...
	public OperationState clone() throws CloneNotSupportedException {
		return new BV_SendOrderState(this.getComment());
	}
