 ...
 * 
 **/
public class BV_RejectedState extends BaseState implements OperationState {

	public BV_RejectedState() {
		super(OperationState.Type.Rejected, MarketCode.BV);
	}

	public BV_RejectedState(String comment) {
		super(OperationState.Type.Rejected, MarketCode.BV);
		setComment(comment);
	}
	...
	public OperationState clone() throws CloneNotSupportedException {
		return new BV_RejectedState(this.getComment());
	}
}
