 ...
 */
package it.softsolutions.bestx.markets.tradeweb.model;
...
/**
 *
 * Purpose: this class represents all the usefull informations that can be
 * extracted from an execution report. Tipically, when an Order is sent, one or
 * more execution reports are received. These informations are saved on data
 * base using Hibernate.
 *
 ...
 * 
 **/
public class TradewebFeedTrade {

    private String execId;
    private String orderId;
    private String clOrdId;
    private String executingFirm;
    private String tradeWebBrokerCode;
    ...
    /**
     * Gets the unique identifier of execution as assigned by sell-side.
     * Uniqueness must be guaranteed within a single trading day or life of a
     * multi-day order.
     * 
     * @return the execId
     */
    ...
    /**
     * Changes the execution Identifier associated to an existing order.
     * 
     * @param execId
     *            the new execution Identifie.
     */
    ...
    /**
     * Gets the unique identifier for order as assigned by sell-side. Uniqueness
    ...
    /**
     * Changes the Order identifier. Uniqueness must be guaranteed within a
     * single trading day.
     * 
     * @param orderId
    ...
    /**
     * Gets the identifier of the order as assigned by the Buy-Side. Uniqueness
     * must be guaranteed within a single trading day.
     * 
     * @return the clOrdId, i.e the identifier of the order as assigned by the
     *         Buy-Side.
     */
    ...
    /**
     * Changes the order identifier as assigned by the Buy-Side.
     * @param clOrdId
     *            the new order identifier as assigned by the Buy-Side.
     */
    ...
    /**
     * 
     * @return the tradeWebBrokerCode
     */
    public String getTradewebBrokerCode() {
        return tradeWebBrokerCode;
    }
     ...
     */
    public void setTradewebBrokerCode(String bloombergBrokerCode) {
        this.tradeWebBrokerCode = bloombergBrokerCode;
    }
    ...
    public String toString() {
        ...
        builder.append("TradewebFeedTrade [execId=");
        ...
        builder.append(executingFirm);
        builder.append(", tradeWebBrokerCode=");
        builder.append(tradeWebBrokerCode);
