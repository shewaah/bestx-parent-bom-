...
* 
**/
public class TW_SendOrderState extends BaseState implements OperationState {

	public TW_SendOrderState() {
		super(OperationState.Type.SendOrder, MarketCode.TW);
	}

	public TW_SendOrderState(String comment) {
		super(OperationState.Type.SendOrder, MarketCode.TW);
		setComment(comment);
	}
