 ...
 * 
 **/
public class TW_RejectedState extends BaseState implements OperationState {

	public TW_RejectedState() {
		super(OperationState.Type.Rejected, MarketCode.TW);
	}

	public TW_RejectedState(String comment) {
		super(OperationState.Type.Rejected, MarketCode.TW);
		setComment(comment);
	}
