 ...
 * 
 **/
public class FIXClientTestHelper {

    private static final Logger LOGGER = LoggerFactory.getLogger(FIXClientTestHelper.class);
    ...
    public static void setUp() throws Exception {
        ...
        fixClient.init("bestx-fix-client.properties", new FIXClientCallback() {
        ...
        junit.framework.Assert.assertTrue("Connection to FIX acceptor failed", connected);
    }
    
    protected static BXNewOrderSingle createNewOrderSingle(String clOrdID, String account, String securityID, Side side, Double price, OrdType ordType, Double orderQty, Date futSettDate) throws ParseException {
    ...
    protected static BXOrderCancelRequest createOrderCancelRequest(String clOrdID, String orderID, String origClOrdID, String securityID, Side side, Double orderQty) throws ParseException {
