 ...
 * check the PriceForgeInstrumentsTable - check the MarketSecurityStatus and manage new instruments (XBRIDGE market)
 * 
...
/*            if (priceForgeMktCode.equals(MarketCode.RTFI)) {
        	...
        	if (priceForgeMktCode.equals(MarketCode.XBRIDGE)) {
