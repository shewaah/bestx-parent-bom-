...
* 
**/
public class MATCH_ExecutedState extends BaseState implements Cloneable {
	
   public MATCH_ExecutedState() {
      super(OperationState.Type.MarketExecuted, MarketCode.MATCHING);
   }
   
	@Override
	public OperationState clone() throws CloneNotSupportedException {
		return new MATCH_ExecutedState();
	}
