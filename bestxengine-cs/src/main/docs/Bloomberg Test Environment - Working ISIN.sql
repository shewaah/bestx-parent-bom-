-- List of the working ISIN and MarketMakers for the Bloomberg BPipe Test Environment
...
[Issuer_Name], [Rateo], [BBSettlementDate], [Category], [SubCategory], [InInventory],  [BBGDescription], [StdSettlementDays] 
