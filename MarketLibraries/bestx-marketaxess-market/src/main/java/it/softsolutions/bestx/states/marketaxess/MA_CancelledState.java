 ...
 * 
 **/
public class MA_CancelledState extends BaseState implements OperationState {

	public MA_CancelledState() {
		super(OperationState.Type.Cancelled, MarketCode.MARKETAXESS);
	}

	public MA_CancelledState(String comment) {
		super(OperationState.Type.Cancelled, MarketCode.MARKETAXESS);
		setComment(comment);
	}
	...
	public OperationState clone() throws CloneNotSupportedException {
		return new MA_CancelledState(this.getComment());
	}
}
