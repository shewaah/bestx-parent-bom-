 ...
 * 
 **/
public class MA_RejectedEventHandler extends BaseOperationEventHandler {
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger LOGGER = LoggerFactory.getLogger(MA_RejectedEventHandler.class);
    private final SerialNumberService serialNumberService;
    private BestXConfigurationDao bestXConfigurationDao;

	public MA_RejectedEventHandler(Operation operation, SerialNumberService serialNumberService, BestXConfigurationDao bestXConfigurationDao) {
		super(operation);
