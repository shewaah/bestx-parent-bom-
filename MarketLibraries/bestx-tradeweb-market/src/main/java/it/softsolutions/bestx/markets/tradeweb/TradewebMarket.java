 ...
 * 
 **/
public class TradewebMarket extends MarketCommon implements TradeStacPreTradeConnectionListener, TradeXpressConnectionListener, ConnectionListener, MarketBuySideConnection, MarketPriceConnection, TimerEventListener, Connection, MarketMXBean {
	 ...
	 */
	 ...
	 public MarketPriceConnection getPriceConnection() {
	    ...
	    public void onExecutionReport(String sessionId, String clOrdID, TSExecutionReport tsExecutionReport) {
	        ...
	        LOGGER.debug("sessionId = {}, clOrdID = {}, execType = {}, ordStatus = {}, accruedInterestAmount = {}, accruedInterestRate = {}, lastPrice = {}, contractNo = {}, futSettDate = {}, transactTime = {}, text = {}",
	        			sessionId, clOrdID, execType, ordStatus, accruedInterestAmount,
	                        accruedInterestRate, lastPrice, contractNo, futSettDate, transactTime, text);
	         ...
	         try {
	            ...
	            executor.execute(new OnExecutionReportRunnable(operation, this, market, cleanClOrdId, execType, ordStatus, accruedInterestAmount, accruedInterestRate, lastPrice, contractNo, futSettDate, transactTime, cleanText, mmm, micCode));
