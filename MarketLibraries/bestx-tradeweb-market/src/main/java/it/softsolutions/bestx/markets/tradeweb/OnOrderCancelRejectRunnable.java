...
public class OnOrderCancelRejectRunnable implements Runnable {
     ...
     *            the TradeWeb market.
     */
    public OnOrderCancelRejectRunnable(String origClOrdId, String reason, TradewebMarket market) {
        this.market = market;
        this.reason = reason;
    ...
    public void run() {
        try {
            final Operation operation = market.getOperationRegistry().getExistingOperationById(OperationIdType.TRADEWEB_CLORD_ID, origClOrdId);
